...
const sidebarItems = [
  { name: 'Oversikt', href: '/', icon: BarChart3 },
...
export function Sidebar() {
  ...
  return (
    <div className='flex h-screen bg-gray-100'>
      ...
      <aside className='hidden md:flex md:flex-shrink-0 fixed top-0 left-0 h-full w-64 border-r border-gray-200 bg-white z-50'>
        <div className='flex flex-col h-full'>
          <div className='flex-1 flex flex-col pt-5 pb-4 overflow-y-auto'>
            <div className='flex items-center flex-shrink-0 px-4'>
              <span className='text-xl font-semibold'>Forsikingshjelpen</span>
            </div>
